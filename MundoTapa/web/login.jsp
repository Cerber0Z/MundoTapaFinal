        ...
        <div class="container-login100">
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
                <div class="d-flex justify-content-center">
                    <a href="index.jsp"><img src="img/favicon.png" class="brand_logo" alt="Logo" style="margin-left: 32%; margin-top: -20%;"></a>
                </div>
                <form class="login100-form validate-form">
                    ...
                    <div class="container-login100-form-btn">
                        <button type="button" id="btnaceptar" class="login100-form-btn" name="btnIngresar" onclick="IniciarSesionUsuario()">Ingresar</button>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-center links">
                            <a href="recuperarcontraseña.jsp" style="text-decoration: none;" >¿Olvidaste tu contraseña?</a>
                        </div>
                    </div>
                </form>
            </div>

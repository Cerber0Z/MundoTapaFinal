 ...
 * @author sergi
 */
@WebServlet(name = "Afiliado", urlPatterns = {"/Afiliado"})
public class Afiliado extends HttpServlet {
    ...
    Uusuario uus = new Uusuario();
    UusuarioDAO uusDAO = new UusuarioDAO();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (Rol == null) {
                ...
                if (Rol.equals(1)) {
                    ...
                    if (menu.equals("Afiliado")) {
                        switch (accion) {
                            case "ListarAfiliados":
                                
                                Object listap = prsDAO.SelecionarAfiliados();
                                request.setAttribute("Listap", listap);
                                List listrol = uusDAO.listrol();
